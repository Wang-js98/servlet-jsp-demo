    ...
    <div id="right">
        ...
        <div class="right-group">
            ...
            <table class="table table-hover">
                ...
                <c:forEach items="${requestScope.coursePlanPages.data}" var="data">
                    <tr>
            ...
            <br> 共${coursePlanPages.pageCount }页  当前第${requestScope.coursePlanPages.currentPage}页
            <c:if test="${coursePlanPages.currentPage != 1}">
                <a href="coursePlanServlet?action=CoursePlanPage&pageNo=1" >首页</a>
                <a href="coursePlanServlet?action=CoursePlanPage&pageNo=${coursePlanPages.currentPage-1 }" >上一页</a>
            </c:if>


            <c:if test="${coursePlanPages.currentPage != coursePlanPages.pageCount}">
                <a href="coursePlanServlet?action=CoursePlanPage&pageNo=${coursePlanPages.currentPage+1 }" >下一页</a>
                <a href="coursePlanServlet?action=CoursePlanPage&pageNo=${coursePlanPages.pageCount }" >尾页</a>
            </c:if>
        </div>
